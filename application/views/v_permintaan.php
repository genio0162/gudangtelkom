            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-md-4 col-md-offset-4">
                        ...
                        <form id="quickForm" method="POST" action="<?= base_url('transaksi/proccess_out') ?>">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-8">
                                        <label for="unit_name">Jenis</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="tujuan">
                                        <?php foreach ($area_gudang as $a) : ?>
                                            <option><?= $a['namaso'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Detail</label>
                                <input type="text" name="item_name" id="item_name" class="form-control" placeholder="Keterangan">
                            </div>
                            <div class="form-group">
                                <label>Jumlah *</label>
                            ...
                            <div class="form-group">
                                <button type="submit" name="kurang" class="btn btn-success btn-flat">
